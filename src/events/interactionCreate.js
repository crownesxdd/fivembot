...
module.exports = {
  ...
  if(interaction.isButton()) {
    ...
    if(interaction.customId.includes(`ban`)) {
        ...
        const isim = new TextInputBuilder().setCustomId('icisim').setLabel("Oyun içi ismi:").setPlaceholder('iqo').setStyle(TextInputStyle.Short)
        ...
        const süre = new TextInputBuilder().setCustomId('banlayan').setLabel("Kim Banladı?:").setPlaceholder('ayko').setStyle(TextInputStyle.Short)
    ...
    if(interaction.customId.includes("sikayet")) {
      ...
      const isim = new TextInputBuilder().setCustomId('sikeden').setLabel("Şikayet Eden:").setPlaceholder('iqo').setStyle(TextInputStyle.Short)
    ...
    if(interaction.customId.includes(`basvuru`)) {
        const modal = new ModalBuilder().setCustomId('basvuruModal').setTitle('Başvuru yap.');
              const isim = new TextInputBuilder().setCustomId('icisim').setLabel("IC / OOC isminiz ve kullanıcı adınız nedir?:").setPlaceholder('iqo').setStyle(TextInputStyle.Short)
    ...
    if(interaction.customId.includes(`yardımbuton`)) {
        ...
        const isim = new TextInputBuilder().setCustomId('icisim').setLabel("Onay İsteyen Birliğin Lider:").setPlaceholder('iqo').setStyle(TextInputStyle.Short)
    ...
    if(interaction.customId.includes(`uyarı`)) {
        ...
        const süre = new TextInputBuilder().setCustomId('uyaran').setLabel("Kim Uyardı?:").setPlaceholder('ayko').setStyle(TextInputStyle.Short)
